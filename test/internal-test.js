...
var res = request('GET', 'http://localhost:3030/internal-test', {timeout: 20000});
...
var res = request('POST', 'http://localhost:3030/internal-test', {timeout: 20000, body: '<body/>' });
...
var res = request('PUT', 'http://localhost:3030/internal-test', {timeout: 20000, body: '<body/>' });
...
var res = request('DELETE', 'http://localhost:3030/internal-test', {timeout: 20000});
